...
/***/ "./src/app/models/usuarioAdoptante.ts":
/*!********************************************!*\
  !*** ./src/app/models/usuarioAdoptante.ts ***!
  \********************************************/
/*! exports provided: UsuarioAdoptante */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UsuarioAdoptante", function() { return UsuarioAdoptante; });
var UsuarioAdoptante = /** @class */ (function () {
    function UsuarioAdoptante(_id, correo, password, nombres, apellidos, edad, foto) {
        this._id = _id;
        this.correo = correo;
        this.password = password;
    ...
    UsuarioAdoptante.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var UsuarioService = /** @class */ (function () {
    function UsuarioService(transfer, _http, _route, _router) {
        this.transfer = transfer;
        this._http = _http;
        this._route = _route;
        this._router = _router;
        this.url = _global__WEBPACK_IMPORTED_MODULE_5__["GLOBAL"].url;
    }
    UsuarioService.prototype.login = function (usuario, gettoken) {
    ...
    UsuarioService.prototype.loginFB = function (usuario, gettoken) {
        if (gettoken === void 0) { gettoken = null; }
        if (gettoken != null) {
            usuario.gettoken = gettoken;
        }
    ...
    UsuarioService.prototype.obtUsuario = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
        return this._http.get(this.url + 'usuario/' + id, { headers: headers });
    };
    UsuarioService.prototype.uploadUser = function (img, user) {
        var url = this.url + 'registrarAdoptante';
        var options = {
            fileKey: 'foto',
            chunkedMode: false,
    ...
    UsuarioService.prototype.validUser = function (usuario) {
        var params = JSON.stringify(usuario);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
        return this._http.post(this.url + 'valid-usuario', params, { headers: headers });
    };
    UsuarioService.prototype.errrp = function (errp) {
        var params = JSON.stringify(this.errrp);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
        return this._http.post(this.url + 'errorprueba', params, { headers: headers });
    };
    UsuarioService.prototype.obtIdentity = function () {
        var identity = JSON.parse(localStorage.getItem('identityMobile'));
    ...
    UsuarioService.prototype.obtToken = function () {
    ...
    UsuarioService.prototype.obtUsuariosRol = function (page, rol) {
    ...
    UsuarioService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_3__["FileTransfer"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"],
