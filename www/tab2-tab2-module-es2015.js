...
let Tab2Page = class Tab2Page {
    constructor(toastController, _usuarioService, fb, nativeStorage, _route, _router) {
    ...
    obtFundaciones(page, adding = false) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let rol = 4;
            yield this._usuarioService.obtUsuariosRol(page, rol).subscribe(response => {
