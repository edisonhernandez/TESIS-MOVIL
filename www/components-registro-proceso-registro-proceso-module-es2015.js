...
let RegistroProcesoPageModule = class RegistroProcesoPageModule {
};
...
let RegistroProcesoPage = class RegistroProcesoPage {
    constructor(/*public _uploadService:UploadService,*/ nativeStorage, actionSheetController, camera, activeRoute, _route, _router, _usuarioService, toastController, loadingController) {
    ...
    registrarUsuario() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this._usuarioService.uploadUser(this.mensaje, this.usuarioAdoptante).then(response => {
                this.usuarioLogin.correo = this.usuarioAdoptante.correo;
                this.usuarioLogin.password = this.usuarioAdoptante.password;
                this._usuarioService.login(this.usuarioLogin, 'true').subscribe(response => {
...
RegistroProcesoPage.ctorParameters = () => [
...
//# sourceMappingURL=components-registro-proceso-registro-proceso-module-es2015.js.map