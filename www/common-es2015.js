...
class UsuarioLogin {
    constructor(_id, correo, password, gettoken) {
        this._id = _id;
        this.correo = correo;
...
class UsuarioAdoptante {
    constructor(_id, correo, password, nombres, apellidos, edad, foto) {
        this._id = _id;
        this.correo = correo;
        this.password = password;
...
UsuarioAdoptante.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String },
    { type: String },
...
let UsuarioService = class UsuarioService {
    constructor(transfer, _http, _route, _router) {
