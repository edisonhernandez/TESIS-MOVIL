...
var NotificacionService = /** @class */ (function () {
    function NotificacionService(_http) {
        this._http = _http;
        this.url = _global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].url;
    }
    NotificacionService.prototype.obtNotificaciones = function (id, tipo, page) {
    ...
    NotificacionService.ctorParameters = function () { return [
...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(_notificacionService, nativeStorage) {
    ...
    Tab3Page.prototype.obtenerNotificaciones = function () {
        var _this = this;
        if (this.idU == undefined) {
            this.idU = "5d966fa9882c6d42d8a94b0d";
        }
        this._notificacionService.obtNotificaciones(this.idU, 't', 1).subscribe(function (response) {
            console.log(response);
            _this.notificaciones = response.notificaciones;
        }, function (error) {
            console.log(error);
        });
    };
